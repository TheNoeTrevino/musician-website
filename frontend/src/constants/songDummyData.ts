export const songDummyData = [
  {
    ...
    image: "/albums/standing-on-the-shoulders-of-giants.png",
    price: 49.99,
    quantity: 1,
    year: 2023,
    players: [
      { name: "Solo Marimba 1", instrument: "5.0 Octave Marimba" },
      { name: "Solo Marimba 2", instrument: "5.0 Octave Marimba" },
      {
        name: "Percussion 1",
        instrument: "Glockenspiel, Djembe (Shared with Percussion 3)",
      },
      {
        name: "Percussion 2",
        instrument: "3.0 Octave Vibraphone, Wind Chimes, Shaker",
      },
      {
        name: "Percussion 3",
        instrument:
          "3.0 Octave Vibraphone, Crotales, Suspended Cymbal, Shekere, Djembe",
      },
      {
        name: "Percussion 4",
        instrument:
          "3 Concert Toms, Impact Drum, Hi-Hat, Sizzle Cymbal, Shekere (Mounted), Crotales (Shared with Percussion 3)",
      },
      {
        name: "Percussion 5",
        instrument:
          "Duembek, Kick Drum, Chimes, Concert Bassdrum, Marimba (Shared with Soloist 2)",
      },
      {
        name: "Percussion 6",
        instrument: "Timpani (32”,29”,26”,23”), Suspended Cymbal",
      },
    ],
    grade: 6,
    length: "8:45",
  ...
  },
  {
    ...
    image: "/albums/celestial.png",
    price: 29.99,
    quantity: 2,
    year: 2024,
    players: [
      { name: "Percussion 1", instrument: "4.6 Octave Marimba" },
      { name: "Percussion 2", instrument: "4.6 Octave Marimba" },
      { name: "Percussion 3", instrument: "Crotales, 3.0 Octave Vibraphone" },
      { name: "Percussion 4", instrument: "Glockenspiel" },
      {
        name: "Percussion 5",
        instrument: "Windchimes, Impact Drum, Triangle (High), Snaredrum",
      },
      {
        name: "Percussion 6",
        instrument: "Rainstick, Suspended Cymbal, Triangle (Medium), Hi-Hat",
      },
      { name: "Digital Audio Track", instrument: "Digital Audio Track" },
    ],
    grade: 3,
    length: "4:30",
    electronics: true,
  ...
  },
  {
    ...
    image: "/albums/memento-mori.png",
    price: 49.99,
    quantity: 1,
    year: 2024,
    players: [
      { name: "Solo Marimba", instrument: "5.0 Octave Marimba" },
      { name: "Percussion 1", instrument: "Vibraphone" },
      {
        name: "Percussion 2",
        instrument: "Crotales, Shaker, Suspended Cymbal",
      },
      {
        name: "Percussion 3",
        instrument:
          "Glockenspiel, Suspended Cymbal, Djembe, Duembek, Concert Bass Drum, Tam-Tam",
      },
      {
        name: "Percussion 4",
        instrument:
          "Duembek, Kick Drum, Impact Drum, Djembe, Wind Chimes, Concert Bass Drum, Tam-Tam",
      },
    ],
    grade: 6,
    length: "8:02",
